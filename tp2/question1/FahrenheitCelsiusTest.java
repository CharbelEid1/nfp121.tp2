...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        assertEquals("-10 °F -> -23.3 °C ?", -23.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(-10), 0.1);
        ...
        assertEquals("-40 °F -> -40.0 °C ?", -40.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(-40), 0.1);
    }
