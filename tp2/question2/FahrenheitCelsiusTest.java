...
public class FahrenheitCelsiusTest extends junit.framework.TestCase
{
 ...
 public void test_fahrenheitEnCelsius() {
  ...
  try {
            question2.FahrenheitCelsius.fahrenheitEnCelsius(Integer.parseInt("invalid"));
            fail("NumberFormatException should have been thrown");
        } catch (NumberFormatException e) {
            assertEquals("Error: For input string: \"invalid\"","Error: "+ e.getMessage());
        }

        try {
            question2.FahrenheitCelsius.fahrenheitEnCelsius(Integer.parseInt("123.45"));
            fail("NumberFormatException should have been thrown");
        } catch (NumberFormatException e) {
            assertEquals("Error: For input string: \"123.45\"","Error: "+ e.getMessage());
        }
    }
}
